...
# task 4 : create a function of maximum among 3 numbers
def find_max(a, b, c):
    return max(a, b, c) 
...
# task 5 : Create a function to check if string is palindrome
def is_palindrome(s):
    s = s.replace(" ", "").lower()
...
# task 6 : Create a function to calculate area of circle take a user input to take value
